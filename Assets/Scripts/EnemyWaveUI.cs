...
public class EnemyWaveUI : MonoBehaviour
{
    ...
    private void HandleEnemyWaveSpawnPositionIndicator()
    {
        ...
        enemyWaveSpawnPositionIndicator.eulerAngles = new Vector3(0f, 0f, UtilsClass.GetAngleFromVector(dirToNextSpawnPosition));
    ...
    private void HandleEnemyClosestPositionIndicator()
    {
        ...
        if (targetEnemy != null)
        {
            ...
            enemyClosestPositionIndicator.eulerAngles = new Vector3(0f, 0f, UtilsClass.GetAngleFromVector(dirToClosestEnemy));
